...
display_ICs(H_1, 'H_1_exp2', 'h')
display_ICs(ICs_1, 'ICs_1_exp2', 'p')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%% NN_cmp %%%%%%%%%%%%%
%load('learned_NNs/NN1_exp2_5_2.mat', 'net')
load('learned_NNs/NN1_exp2_10_5.mat', 'net')
N = size(Y, 2);
...
display_ICs(H_cmp, 'H_cmp_exp2', 'g')
display_ICs(ICs_cmp, 'ICs_cmp_exp2', 'q')
...
display_heatmap(H_1, H_cmp, 'H_heatmap_exp2', 'g', 'h')
h = display_heatmap(ICs_1, ICs_cmp, 'ICs_heatmap_exp2', 'q', 'p');
