function [X_no_cnstnt, Y] = data_for_NN1_exp1

filename = "data_for_NN1_exp1.mat";
...
color       = 0; % 0 - 0
%my_color    = 0; % 0 - 2, % 0, 2 % white, dim gray
shape       = 0; % 0 - 1, % 0, 1 % square, ellipse
scale       = 0; % 0 - 5, % 3, 5 % small, big
orientation = 0; % 0 - 39 % 0
position_x  = 0; % 0 - 31 % 0, 8, 16, 23, 31
position_y  = 0; % 0 - 31 % 0, 8, 16, 23, 31
%unique(target_1(1,:))
%データセット2
